...
export default function Demo() {
  ...
  // Initialise messages when mode changes
  useEffect(() => {
      ...
      <section className="px-6 lg:px-10 pb-16 max-w-[1328px] mx-auto">
        <div className="flex flex-col lg:flex-row items-start gap-10 lg:gap-12">
          ...
          <div className="w-full lg:flex-1 lg:pt-4 flex flex-col gap-6">
            ...
            <div className="hidden lg:block h-px bg-border-warm" />

            <button
              onClick={reset}
              className="hidden lg:inline-flex text-[13px] text-text-muted hover:text-text-primary tracking-[-0.01em] transition-colors"
            >
              ↺ Start over
            </button>
          </div>
          ...
          <div className="lg:hidden w-full flex justify-center">
            <button onClick={reset} className="text-[13px] text-text-muted tracking-[-0.01em]">↺ Start over</button>
          </div>
